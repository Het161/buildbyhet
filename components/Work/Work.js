    ...
    () => [
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.FIRSTBOOKIT || []}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.OM_MARKETING || []}
          />
        ),
      },
      {
        title: "OM Solutions",
        value: "om-marketing-solutions",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.OM_MARKETING_SOLUTIONS || []}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.HACKATHONS || []}
          />
        ),
      },
    ],
