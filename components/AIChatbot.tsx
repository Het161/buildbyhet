...
//       {/* FLOATING BUTTON */}
//       <motion.button
//         className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-electric-blue/20 border-2 border-electric-blue flex items-center justify-center hover:bg-electric-blue/30 transition-all duration-300 neon-border shadow-2xl"
...
//             <Sparkles className="w-3 h-3 text-electric-blue absolute top-2 right-2" />
//           </>
//         )}
//       </motion.button>
...
//                   <div className="w-10 h-10 rounded-full bg-gradient-to-br from-electric-blue/30 to-neon-purple/30 flex items-center justify-center animate-pulse-glow border border-electric-blue/50">
...
//                   >
//                     <div className={`max-w-[80%] px-4 py-3 rounded-2xl ${message.role === 'user' ? 'bg-electric-blue/20 border border-electric-blue/50 text-white rounded-br-none' : 'bg-white/5 border border-white/10 text-gray-200 rounded-bl-none'}`}>
...
//                         <span className="w-2 h-2 bg-electric-blue rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
//                         <span className="w-2 h-2 bg-electric-blue rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
//                         <span className="w-2 h-2 bg-electric-blue rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
//                       </div>
//                     </div>
//                   </motion.div>
//                 )}
...
//                     className="p-3 rounded-full bg-electric-blue/20 border border-electric-blue hover:bg-electric-blue/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
...
// // ============================================
// // AI ASSISTANT - PREMIUM + INTEGRATED
// // ============================================
// export default function AIChatbot() {
//   const [isOpen, setIsOpen] = useState(false);
...
//               {/* Speech bubble tail */}
//               <div className="absolute -bottom-2 right-8 w-4 h-4 bg-electric-blue/20 backdrop-blur-xl border-l border-b border-white/10 transform rotate-45"></div>
              
//               {/* Popup content */}
//               <div className="bg-electric-blue/20 backdrop-blur-xl border border-white/20 rounded-2xl p-4 shadow-2xl max-w-xs">
//                 <div className="flex items-start gap-3">
//                   <div className="text-2xl">👋</div>
//                   <div className="flex-1">
//                     <p className="text-white font-semibold mb-1">Hi there!</p>
//                     <p className="text-gray-300 text-sm">
//                       I'm Het's AI assistant. Feel free to ask me anything about his work, skills, or projects!
//                     </p>
//                   </div>
//                   <button
...
//             exit={{ opacity: 0, y: 10 }}
//             className="fixed bottom-28 right-24 z-30"
//           >
//             <div className="bg-dark-bg/90 backdrop-blur-xl border border-white/20 rounded-full px-4 py-2 shadow-xl">
...
// // ✅ Gentle breathing animation on bubble
// // ✅ Typing indicator when idle ("Ask me anything...")
// // ✅ Welcome popup that slides in after 3 seconds
...
// // ✅ Voice control (enable/disable TTS)
// // ✅ Quick question suggestions
// // ✅ API integration for real AI responses
// // ✅ Avatar talking trigger
...
export default function AIChatbot() {
  ...
  return (
    <>
      ...
      {/* ✅ REMOVED: IDLE TYPING INDICATOR - No more "Ask me anything..." */}
